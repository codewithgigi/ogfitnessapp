...
const ExerciseList = [
  ...
  "Back - Latissimus Dorsi,Assisted Pull-Up,Beginner,Upper,Pull,FW,M",
  "Back - Latissimus Dorsi,Close-Grip Lat Pulldown,Beginner,Upper,Pull,M,M",
  "Back - Latissimus Dorsi,Inverted Pull-Up,Advanced,Upper,Pull,FW,M",
  "Back - Latissimus Dorsi,Lat Pulldown,Beginner,Upper,Pull,C,M",
  "Back - Latissimus Dorsi,Pull-Up,Beginner,Upper,Pull,FW,M",
  "Back - Latissimus Dorsi,Reverse-Grip Lat Pullown,Intermediate,Upper,Pull,C,M",
  "Back - Latissimus Dorsi,Reverse-Grip Pull-Up,Advanced,Upper,Pull,FW,M",
  "Back - Latissimus Dorsi,V-Bar Pull-Up,Advanced,Upper,Pull,FW,M",
  "Back - Latissimus Dorsi,Wide-Grip Lat Pulldown,Beginner,Upper,Pull,C,M",
  "Back - Lat.Dorsi/Rhomboids,Bent-Over Alternating Dumbbell Row,Intermediate,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Bent-Over Barbell Row,Beginner,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Bent-Over Dumbbell Row,Beginner,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Bent-Over Hammer Dumbbell Row,Beginner,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Bent-Over Long Barbell Row,Intermediate,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Bent-Over Reverse-Grip Barbell Row,Advanced,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Bent-Over Single-Arm Long Barbell Row,Advanced,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Machine Row,Beginner,Upper,Pull,M,M",
  "Back - Lat.Dorsi/Rhomboids,One Arm Dumbbell Row,Beginner,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Reverse Incline Dumbbell Row,Advanced,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Rope Cable Row,Intermediate,Upper,Pull,C,M",
  "Back - Lat.Dorsi/Rhomboids,Seated Cable Row,Beginner,Upper,Pull,C,M",
  "Back - Lat.Dorsi/Rhomboids,Seated Row,Beginner,Upper,Pull,C,M",
  "Back - Lat.Dorsi/Rhomboids,Single-Arm Cable Row,Intermediate,Upper,Pull,C,M",
  "Back - Lat.Dorsi/Rhomboids,Single-Arm Dumbbell Row,Beginner,Upper,Pull,FW,M",
  "Back - Lat.Dorsi/Rhomboids,Single-Arm Lat Pulldown,Intermediate,Upper,Pull,C,M",
  "Back - Lat.Dorsi/Rhomboids,Standing Cable Row,Beginner,Upper,Pull,C,M",
  "Back - Lat.Dorsi/Rhomboids,Standing Single-Arm Cable Row,Intermediate,Upper,Pull,C,M",
  ...
  "Calves - Gastrocnemius,Barbell Calf Raise,Advanced,Lower,Push,FW,S",
  "Calves - Gastrocnemius,Calf Press,Beginner,Lower,Push,M,S",
  "Calves - Gastrocnemius,Calf Raise - Seated,Beginner,Lower,Push,FW,S",
  "Calves - Gastrocnemius,Calf Raise - Standing,Beginner,Lower,Push,FW,S",
  "Calves - Gastrocnemius,Dumbbell Calf Raise,Beginner,Lower,Push,FW,S",
  "Calves - Gastrocnemius,Single-Leg Calf Press,Advanced,Lower,Push,M,S",
  "Calves - Gastrocnemius,Single-Leg Dumbbell Calf Raise,Advanced,Lower,Push,FW,S",
  "Calves - Gastrocnemius,Smith Machine Calf Raise,Intermediate,Lower,Push,M,S",
  "Calves - Soleus,Seated Calf Raise,Beginner,Lower,Push,M,S",
  "Calves - Soleus,Seated Single-Leg Calf Raise,Intermediate,Lower,Push,M,S",
  "Chest - Pectoralis,Alternating Dumbbell Bench Press,Intermediate,Upper,Push,FW,M",
  "Chest - Pectoralis,Barbell Bench Press,Intermediate,Upper,Push,FW,M",
  "Chest - Pectoralis,Chest Press,Beginner,Upper,Push,M,M",
  "Chest - Pectoralis,Decline Dumbbell Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Decline Smith Machine Bench Press,Advanced,Upper,Push,M,M",
  "Chest - Pectoralis,Dumbbell Bench Press,Beginner,Upper,Push,FW,M",
  "Chest - Pectoralis,Dumbbell Push-Up,Beginner,Upper,Push,FW,M",
  "Chest - Pectoralis,Elevated Push-Up,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Flat Bench Press,Intermediate,Upper,Push,FW,M",
  "Chest - Pectoralis,Incline Alternating Dumbbell Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Incline Barbell Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Incline Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Incline Dumbbell Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Incline Hammer Dumbbell Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Incline Single-Arm Dumbbell Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Incline Smith Machine Bench Press,Advanced,Upper,Push,M,M",
  "Chest - Pectoralis,Incline Twisting Dumbbell Bench Press,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Kneeling Push-Up,Beginner,Upper,Push,FW,M",
  "Chest - Pectoralis,Machine Bench Press,Beginner,Upper,Push,M,M",
  "Chest - Pectoralis,Machine Vertical Bench Press,Beginner,Upper,Push,M,M",
  "Chest - Pectoralis,Medicine Ball Crossover Push-Up,Advanced,Upper,Push,FW,M",
  "Chest - Pectoralis,Push-Up,Beginner,Upper,Push,FW,M",
  "Chest - Pectoralis,Single-Arm Dumbbell Bench Press,Intermediate,Upper,Push,FW,M",
  "Chest - Pectoralis,Smith Machine Bench Press,Intermediate,Upper,Push,M,M",
  "Chest - Pectoralis,Twisting Dumbbell Bench Press,Beginner,Upper,Push,FW,M",
  "Chest - Pectoralis,Wide-Grip Push-Up,Beginner,Upper,Push,FW,M",
  "Chest - Pectoralis,Cable Crossover,Advanced,Upper,Push,C,S",
  "Chest - Pectoralis,Cable Fly,Advanced,Upper,Push,C,S",
  "Chest - Pectoralis,Decline Dumbbell Fly,Advanced,Upper,Push,FW,S",
  "Chest - Pectoralis,Dumbbell Fly,Beginner,Upper,Push,FW,S",
  "Chest - Pectoralis,High Cable Crossover,Advanced,Upper,Push,C,S",
  "Chest - Pectoralis,Incline Cable Fly,Advanced,Upper,Push,C,S",
  "Chest - Pectoralis,Incline Dumbbell Fly,Advanced,Upper,Push,FW,S",
  "Chest - Pectoralis,Incline Twisting Dumbbell Fly,Advanced,Upper,Push,FW,S",
  "Chest - Pectoralis,Low Cable Crossover,Intermediate,Upper,Push,C,S",
  "Chest - Pectoralis,Pec Deck,Beginner,Upper,Push,M,S",
  "Chest - Pectoralis,Pec Deck Fly,Beginner,Upper,Push,M,S",
  ...
  "Lower Back - Erector Spinae,Alternating Superman,Beginner,Core,Pull,FW,M",
  "Lower Back - Erector Spinae,Back Raise,Beginner,Core,Pull,FW,M",
  "Lower Back - Erector Spinae,Quadruped Alternating Superman,Beginner,Core,Pull,FW,M",
  "Lower Back - Erector Spinae,Superman,Beginner,Core,Pull,FW,M",
  "Lower Back - Erector Spinae,Superman Hold,Beginner,Core,Pull,FW,M",
  "Shoulders - Delts/Traps,Arnold Dumbbell Press,Intermediate,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Barbell Shoulder Press,Advanced,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Dumbbell Alternating Shoulder Press,Beginner,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Dumbbell Front Raise,Beginner,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Dumbbell Shoulder Press,Intermediate,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Dumbbell Twisting Shoulder Press,Intermediate,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Machine Shoulder Press,Beginner,Upper,Push,M,M",
  "Shoulders - Delts/Traps,Seated Dumbbell Rear Delt Elbow Raise,Intermediate,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Single-Arm Dumbbell Shoulder Press,Beginner,Upper,Push,FW,M",
  "Shoulders - Delts/Traps,Smith Machine Shoulder Press,Advanced,Upper,Push,M,M",
  "Shoulders - Delts/Traps,Barbell Front Raise,Intermediate,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Bent-Over Cable Rear Delt Raise,Advanced,Upper,Push,C,S",
  "Shoulders - Delts/Traps,Bent-Over Dumbbell Rear Delt Raise,Intermediate,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Cable Front Raise,Intermediate,Upper,Push,C,S",
  "Shoulders - Delts/Traps,Cable Lateral Raise,Intermediate,Upper,Push,C,S",
  "Shoulders - Delts/Traps,Dumbbell Lateral Raise,Beginner,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Front Plate Raise,Beginner,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Kneeling Single-Arm Cable Rear Delt Raise,Advanced,Upper,Push,C,S",
  "Shoulders - Delts/Traps,Lying Dumbbell External Rotation,Beginner,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Lying Dumbbell Rear Delt Raise,Beginner,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Lying Single-Arm Dumbbell Rear Delt Raise,Beginner,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Pec Deck Real Delt Extensions,Intermediate,Upper,Push,M,S",
  "Shoulders - Delts/Traps,Reverse Incline Dumbbell Rear Delt Raise,Advanced,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Seated Dumbbell Rear Delt Raise,Beginner,Upper,Push,FW,S",
  "Shoulders - Delts/Traps,Single-Arm Cable Lateral Raise,Intermediate,Upper,Push,C,S",
  "Shoulders - Rotator Cuff,Cable External Rotation,Beginner,Upper,Push,C,S",
