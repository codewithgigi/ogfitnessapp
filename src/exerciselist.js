...
export const ExerciseList = [
  "Abs,Full Reverse Crunch,Advanced,Core,Push,FW,M",
  "Abs,Incline Hip Thrust,Advanced,Core,Push,FW,M",
  "Abs,Incline Reverse Crunch,Advanced,Core,Push,FW,M",
  "Abs,Lying Hip Thrust,Advanced,Core,Push,FW,M",
  "Abs,Reverse Crunch,Beginner,Core,Push,FW,M",
  "Abs,Reverse Medicine Ball Crunch,Advanced,Core,Push,FW,M",
  "Abs,Alternating Heel Touch,Beginner,Core,Push,FW,M",
  "Abs,Bent-Knee Medicine Ball Hip Rotation,Advanced,Core,Push,FW,M",
  "Abs,Cable Chop,Advanced,Core,Push,C,M",
  "Abs,Cross Crunch,Beginner,Core,Push,FW,M",
  "Abs,Cross Crunch w/ Medicine Ball,Advanced,Core,Push,FW,M",
  "Abs,Decline Cross Sit-Up,Advanced,Core,Push,FW,M",
  "Abs,Decline Sit-Up w/ Twist,Advanced,Core,Push,FW,M",
  "Abs,Reverse Cable Chop,Advanced,Core,Push,C,M",
  "Abs,Seated Medicine Ball Twist,Advanced,Core,Push,FW,M",
  "Abs,Trunk Rotator,Advanced,Core,Push,FW,M",
  "Abs,Front Plank (from knees),Beginner,Core,Static,FW,M",
  "Abs,Front Plank (from toes),Intermediate,Core,Static,FW,M",
  "Abs,Front Plank (tripod - 1 arm and 2 legs or 2 legs and 1 arm),Advanced,Core,Static,FW,M",
  "Abs,Side-Plank (from knees),Intermediate,Core,Static,FW,M",
  "Abs,Side-Plank (hip lift),Beginner,Core,Static,FW,M",
  "Abs,Side-Plank (from toes),Advanced,Core,Static,FW,M",
  "Abs,Ab Cycle,Advanced,Core,Push,FW,M",
  "Abs,Kneeling Ab Rollout,Intermediate,Core,Push,FW,M",
  "Abs,Medicine Ball V-Up,Advanced,Core,Push,FW,M",
  "Abs,V-Up,Beginner,Core,Push,FW,M",
  "Abs,Weighted V-Up,Intermediate,Core,Push,FW,M",
  "Abs,Bent Knee Sit-Up,Beginner,Core,Push,FW,M",
  "Abs,Bent-Knee Crunch,Beginner,Core,Push,FW,M",
  "Abs,Crunch,Beginner,Core,Push,FW,M",
  "Abs,Crunch,Beginner,Core,Push,FW,M",
  "Abs,Decline Crunch,Advanced,Core,Push,FW,M",
  "Abs,Decline Sit-Up,Advanced,Core,Push,FW,M",
  "Abs,Heel Touch,Beginner,Core,Push,FW,M",
  "Abs,Sit-Up,Beginner,Core,Push,FW,M",
  "Abs,Weighted Crunch,Intermediate,Core,Push,FW,M",
  "Abs,Hanging Leg Raise,Advanced,Core,Pull,FW,M",
  "Abs,Hanging Knee Raise,Advanced,Core,Pull,FW,M",
  ...
  "Biceps,Alternating Dumbbell Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Alternating Hammer Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Barbell Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Bicep Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Bottom/Top/Full Curls,Advanced,Upper,Pull,FW,S",
  "Biceps,Cable Curl,Intermediate,Upper,Pull,C,S",
  "Biceps,Concentration Dumbbell Curl,Intermediate,Upper,Pull,FW,S",
  "Biceps,Cross Body Hammer Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Dumbbell Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,EZ-Bar Curl,Intermediate,Upper,Pull,FW,S",
  "Biceps,Hammer Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Incline Alternating Dumbbell Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Incline Alternating Hammer Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Incline Dumbbell Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Incline Hammer Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Kneeling Cable Curl,Beginner,Upper,Pull,C,S",
  "Biceps,Lying Cable Curl,Intermediate,Upper,Pull,C,S",
  "Biceps,Lying Double Biceps Cable Curl,Intermediate,Upper,Pull,C,S",
  "Biceps,Lying High Cable Curl,Advanced,Upper,Pull,C,S",
  "Biceps,Machine Curl,Beginner,Upper,Pull,M,S",
  "Biceps,Overhead Double Biceps Cable Curl,Advanced,Upper,Pull,C,S",
  "Biceps,Overhead Rope Cable Curl,Advanced,Upper,Pull,C,S",
  "Biceps,Preacher Barbell Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Preacher Cable Curl,Advanced,Upper,Pull,C,S",
  "Biceps,Preacher Dumbbell Curl,Intermediate,Upper,Pull,FW,S",
  "Biceps,Preacher EZ-Bar Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Preacher Hammer Dumbbell Curl,Intermediate,Upper,Pull,FW,S",
  "Biceps,Preacher Single-Arm Dumbbell Curl,Intermediate,Upper,Pull,FW,S",
  "Biceps,Reverse Curl,Advanced,Upper,Pull,FW,S",
  "Biceps,Rope Cable Curl,Intermediate,Upper,Pull,C,S",
  "Biceps,Seated Alternating Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Seated Alternating Hammer Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Seated Dumbbell Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Seated Hammer Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Single-Arm Barbell Curl,Beginner,Upper,Pull,FW,S",
  "Biceps,Single-Arm Cable Curl,Intermediate,Upper,Pull,FW,S",
  "Biceps,Single-Arm Dumbbell Curl w/ Incline Bench,Beginner,Upper,Pull,FW,S",
  "Biceps,Spider Curl,Advanced,Upper,Pull,FW,S",
  ...
  "Hamstrings,Bent-Knee Single-Leg Hip Lift,Advanced,Lower,Pull,FW,M",
  "Hamstrings,Elevated Hip Lift,Intermediate,Lower,Pull,FW,M",
  "Hamstrings,Elevated Single-Leg Hip Lift,Advanced,Lower,Pull,FW,M",
  "Hamstrings,Hip Lift,Beginner,Lower,Pull,FW,M",
  "Hamstrings,Single-Leg Hip Lift,Intermediate,Lower,Pull,FW,M",
  "Hamstrings,Deadlift,Advanced,Lower,Pull,FW,S",
  "Hamstrings,Leg Curl,Beginner,Lower,Pull,M,S",
  "Hamstrings,Lying Alternating Leg Curl,Intermediate,Lower,Pull,M,S",
  "Hamstrings,Lying Leg Curl,Beginner,Lower,Pull,M,S",
  "Hamstrings,Lying Single-Leg Curl,Intermediate,Lower,Pull,M,S",
  "Hamstrings,Seated Leg Curl,Beginner,Lower,Pull,M,S",
  "Quads,Barbell Diagonal Lunge,Advanced,Lower,Push,FW,M",
  "Quads,Barbell Hack Squat,Advanced,Lower,Push,FW,M",
  "Quads,Barbell Lunge,Intermediate,Lower,Push,FW,M",
  "Quads,Barbell Reverse Lunge,Intermediate,Lower,Push,FW,M",
  "Quads,Barbell Side Lunge,Intermediate,Lower,Push,FW,M",
  "Quads,Barbell Split Squat,Advanced,Lower,Push,FW,M",
  "Quads,Barbell Squat,Beginner,Lower,Push,FW,M",
  "Quads,Barbell Step-Up,Advanced,Lower,Push,FW,M",
  "Quads,Barbell Walking Lunge,Advanced,Lower,Push,FW,M",
  "Quads,Diagonal Lunge,Intermediate,Lower,Push,FW,M",
  "Quads,Dumbbell Diagonal Lunge,Advanced,Lower,Push,FW,M",
  "Quads,Dumbbell Lunge,Beginner,Lower,Push,FW,M",
  "Quads,Dumbbell Reverse Lunge,Intermediate,Lower,Push,FW,M",
  "Quads,Dumbbell Side Lunge,Intermediate,Lower,Push,FW,M",
  "Quads,Dumbbell Split Squat,Advanced,Lower,Push,FW,M",
  "Quads,Dumbbell Squat,Beginner,Lower,Push,FW,M",
  "Quads,Dumbbell Step-Up,Beginner,Lower,Push,FW,M",
  "Quads,Dumbbell Walking Lunge,Advanced,Lower,Push,FW,M",
  "Quads,Forward Lunge,Beginner,Lower,Push,FW,M",
  "Quads,Lateral Barbell Squat,Intermediate,Lower,Push,FW,M",
  "Quads,Lateral Barbell Step-Up,Advanced,Lower,Push,FW,M",
  "Quads,Lateral Squat,Beginner,Lower,Push,FW,M",
  "Quads,Lateral Step-Up,Beginner,Lower,Push,FW,M",
  "Quads,Leg Press,Beginner,Lower,Push,M,M",
  "Quads,Lunge,Beginner,Lower,Push,FW,M",
  "Quads,Lying Machine Squat,Beginner,Lower,Push,M,M",
  "Quads,Machine Hack Squat,Beginner,Lower,Push,M,M",
  "Quads,Reverse Lunge,Beginner,Lower,Push,FW,M",
  "Quads,Single-Arm Barbell Side Squat,Advanced,Lower,Push,FW,M",
  "Quads,Single-Arm Dumbbell Side Squat,Intermediate,Lower,Push,FW,M",
  "Quads,Single-Leg Barbell Squat,Advanced,Lower,Push,FW,M",
  "Quads,Single-Leg Box Squat,Advanced,Lower,Push,FW,M",
  "Quads,Single-Leg Dumbbell Box Squat,Advanced,Lower,Push,FW,M",
  "Quads,Single-Leg Dumbbell Squat,Intermediate,Lower,Push,FW,M",
  "Quads,Single-Leg Squat,Intermediate,Lower,Push,FW,M",
  "Quads,Smith Machine Squat,Intermediate,Lower,Push,M,M",
  "Quads,Split Squat,Advanced,Lower,Push,FW,M",
  "Quads,Step-Up,Beginner,Lower,Push,FW,M",
  "Quads,Walking Lunge,Intermediate,Lower,Push,FW,M",
  "Quads,Alternating Leg Extension,Intermediate,Lower,Push,M,S",
  "Quads,Leg Extension,Beginner,Lower,Push,M,S",
  "Quads,Single-Leg Extension,Intermediate,Lower,Push,M,S",
  "Back,Alternating Superman,Beginner,Core,Pull,FW,M",
  "Back,Back Raise,Beginner,Core,Pull,FW,M",
  "Back,Quadruped Alternating Superman,Beginner,Core,Pull,FW,M",
  "Back,Superman,Beginner,Core,Pull,FW,M",
  "Back,Superman Hold,Beginner,Core,Pull,FW,M",
