export const musclegainFemale45B = {
  name: "Muscle gain program",
  subtitle: "Beginner female",
  id: "female-age-45+-beginner-musclegain",
  goal: ["muscle-gain"],
  level: ["beginner"],
  gender: ["female"],
  age: ["45+"],
  ...
  workoutList: [
    {
      ...
      exercises: [
        { name: "Pulse squat", sets: 2, reps: "10" },
        { name: "Legs extensions", sets: "2-3", reps: "10-12" },
        { name: "Lying leg curls", sets: "2-3", reps: "10-12" },
        { name: "Sumo squat", sets: "2-3", reps: "10-15" },
        { name: "Standing lateral raises DB", sets: "2-3", reps: "10-12" },
        { name: "Rear delt Pec-Deck", sets: "2-3", reps: "10-12" },
        { name: "Cable push down", sets: "2-3", reps: "12-15" },
        { name: "Abs crunches in machine", sets: "2-3", reps: "10-15" },
      ],
      cooldown: {
        instructions: "Stretching and Cardio bicycle 8-10 min",
      },
    },
    {
      day: 2,
    ...
    },
    {
      ...
      cooldown: {
        instructions: "Stretching \n Cardio ellipsoid 8-10 min low intensity",
      },
    },
    {
      day: 4,
    ...
    {
      id: "weight-training-day7",
      name: "weight training",
      day: 7,
      warmup: {
        instructions:
          "Warm up 5 min stretching,warm up exercises \n Cardio bicycle 10 min low intensity",
      },
      exercises: [
      ...
      cooldown: {
        instructions: "Stretching \n Cardio bicycle 8-10 min low intensity",
      },
    },
  ],
};
