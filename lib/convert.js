export function convertFromFraction(value) {
...
export function findQuantityAndConvertIfUnicode(ingredientLine) {
  ...
  if (ingredientLine.match(numericAndFractionRegex)) {
    return [
      ingredientLine.match(numericAndFractionRegex) &&
...
export const unitToGrams = (unit) => {
  const conversion = [
    { unit: "tsp", value: 4.1 },
    { unit: "Tbsp", value: 12.5 },
    { unit: "cup", value: 100 },
    { unit: "small", value: 80 },
    { unit: "medium", value: 100 },
    { unit: "large", value: 120 },
    { unit: "oz", value: 28 },
    { unit: "pound", value: 453 },
    { unit: "can", value: 126 },
  ];

  let result = conversion.find((x) => x.unit === unit);
  return result?.value ?? "";
};
